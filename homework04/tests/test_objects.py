...
from homework04.pyvcs import index, objects, porcelain, repo, tree


@unittest.skipIf(homework04.pyvcs.__version_info__ < (0, 2, 0), "Нужна версия пакета 0.2.0 и выше")
...
@unittest.skipIf(homework04.pyvcs.__version_info__ < (0, 3, 0), "Нужна версия пакета 0.3.0 и выше")
