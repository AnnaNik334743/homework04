...
from homework04.pyvcs.refs import get_ref, is_detached, ref_resolve, resolve_head, update_ref
from homework04.pyvcs.repo import repo_create


@unittest.skipIf(homework04.pyvcs.__version_info__ < (0, 7, 0), "Нужна версия пакета 0.7.0 и выше")
