...
from homework04.pyvcs.index import GitIndexEntry, ls_files, read_index, update_index, write_index
from homework04.pyvcs.repo import repo_create


@unittest.skipIf(homework04.pyvcs.__version_info__ < (0, 4, 0), "Нужна версия пакета 0.4.0 и выше")
