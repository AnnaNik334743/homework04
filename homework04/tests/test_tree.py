...
import homework04.pyvcs
from homework04.pyvcs.index import read_index, update_index
from homework04.pyvcs.repo import repo_create
from homework04.pyvcs.tree import commit_tree, write_tree


@unittest.skipIf(homework04.pyvcs.__version_info__ < (0, 5, 0), "Нужна версия пакета 0.5.0 и выше")
...
@unittest.skipIf(homework04.pyvcs.__version_info__ < (0, 6, 0), "Нужна версия пакета 0.6.0 и выше")
